...
function Devdoro({ Component, pageProps }: AppProps) {
	return (
		<>
			<Head>
				<meta name="application-name" content="Devdoro" />
				<meta name="apple-mobile-web-app-capable" content="yes" />
				<meta name="apple-mobile-web-app-status-bar-style" content="default" />
				<meta name="apple-mobile-web-app-title" content="Devdoro" />
				...
				<meta name="twitter:description" content="A pomodoro application for devs who forget to move." />
				...
				<meta property="og:description" content="A pomodoro application for devs who forget to move. Photo by Victor Miyata on Pexels" />
