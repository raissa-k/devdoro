	...
	return (
	  <>
		{ isLightMode ? (
			...
			className="btn-link no-underline rounded-2xl flex flex-col justify-center items-center flex-grow-0 p-2 hover:opacity-60 transition-opacity text-accent-content" 
