...
export default function FilterMenu() {
	...
	return (
		<details className="pt-4 w-full">
			<summary className="btn btn-sm btn-square btn-primary" aria-label="Filter tasks">
			...
			<ul aria-label="Filter tasks"
				className="flex justify-around mt-2 bg-base-100 rounded-md p-2 shadow-md shadow-primary/20">
