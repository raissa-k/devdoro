...
export default function ThemeChanger() {
	...
	return (
	  <>
		{ isLightMode ? (
			<button className="md:top-20 md:left-4 md:absolute btn btn-xs btn-circle btn-ghost mb-4" onClick={handleChangeTheme}
			data-set-theme="winterdark" data-act-class="btn-active">
				...
				<button className="md:top-20 md:left-4 md:absolute btn btn-xs btn-circle btn-ghost mb-4" onClick={handleChangeTheme}
				data-set-theme="winterlight" data-act-class="btn-active">
