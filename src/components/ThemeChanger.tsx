...
export default function ThemeChanger() {
	...
	return (
	  <>
		{ isLightMode ? (
			<button className="btn-link no-underline flex flex-col justify-center items-center flex-grow-0 p-2 hover:opacity-60 transition-opacity text-accent-content" onClick={handleChangeTheme}
			data-set-theme="winterdark" data-act-class="opacity-80">
				...
				<button className="btn-link no-underline flex flex-col justify-center items-center flex-grow-0 p-2 hover:opacity-60 transition-opacity text-accent-content" onClick={handleChangeTheme}
				data-set-theme="winterlight" data-act-class="opacity-80">
